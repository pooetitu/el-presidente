...
public class EventTest extends TestCase {
    ...
    protected void setUp() throws Exception {
        ...
        eventEffectsMultipleChoice2[0] = new EventEffectFactionSatisfaction("+15 % de satisfaction pour les capitalistes,", 15,false, new CalculationFixed());
        eventEffectsMultipleChoice2[0].addFaction("capitalistes");
        eventEffectsMultipleChoice2[1] = new EventEffectFactionSatisfaction(" -15 % de satisfaction pour les loyalistes", -15,false, new CalculationFixed());
