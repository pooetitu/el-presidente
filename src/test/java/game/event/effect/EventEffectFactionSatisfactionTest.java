...
public class EventEffectFactionSatisfactionTest extends TestCase {
    ...
    protected void setUp() throws Exception {
        super.setUp();
        eventEffectNegative = new EventEffectFactionSatisfaction("-15% influence capitalistes", -15,false, new CalculationFixed());
        eventEffectNegative.addFaction("capitalistes");

        eventEffectPositive = new EventEffectFactionSatisfaction("+15% influence capitalistes", 15,false, new CalculationFixed());
        eventEffectPositive.addFaction("capitalistes");

        eventEffectPositiveOnZero = new EventEffectFactionSatisfaction("+15% influence libéraux", 15,false, new CalculationFixed());
        eventEffectPositiveOnZero.addFaction("libéraux");

        eventEffectSmallerThanZero = new EventEffectFactionSatisfaction("-15% influence libéraux", 15,false, new CalculationFixed());
        eventEffectSmallerThanZero.addFaction("libéraux");

        eventEffectGreaterThanHundred = new EventEffectFactionSatisfaction("+15% influence communistes", 15,false, new CalculationFixed());
        eventEffectGreaterThanHundred.addFaction("communistes");

        eventEffectMultipleFactions = new EventEffectFactionSatisfaction("+15% influence communistes et communistes", 15,false, new CalculationFixed());
